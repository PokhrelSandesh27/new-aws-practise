...
import ScholarConfigRow from './ScholarConfigRow'
...
const PaymentConfigGroup = (props) => {
    ...
    const onGenerate = (id, index) => {
        props.onGenerateSchloar(id, index)
    }
...
// console.log(payment)
                return <ScholarConfigRow key={`${payment.payment._id}`}
                                         payment={payment} onGenerateScholar={onGenerate}
                    ...
                    <Collapse in={open} timeout="auto" unmountOnExit>
                        <Box margin={1}>
                            <Typography variant="h6" gutterBottom component="div">
                                All ScholarConfig for {payments.grade}
                            </Typography>
                            <Table size="small" aria-label="purchases">
                                <TableHead>
                                    <TableRow>
                                        ...
                                        <TableCell align="left"><b>&nbsp; Generate</b></TableCell>
                                        <TableCell align="left"><b>&nbsp; View</b></TableCell>
                                    </TableRow>
                                </TableHead>
                                <TableBody>
                                    {rows}
